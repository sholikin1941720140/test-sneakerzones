                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($item->approved_by == null)
                                                    <a class="btn btn-primary btn-sm" href="{{url('/spv-pengajuan/edit/'.$item->id)}}" title="Edit">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm ondelete" href="{{url('/spv-pengajuan/delete/'.$item->id)}}" title="Hapus">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                @else
                                                    <button class="btn btn-secondary btn-sm" disabled title="Tidak dapat diedit">
