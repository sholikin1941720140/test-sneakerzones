                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-success">
                                                    ...
                                                    <br><small>({{$item->jumlah_approved}} kali)</small>
                                                </span>
                                            </td>
                                            <td>
                                                <span class="badge badge-warning">
                                                    {{number_format($item->total_lembur_pending, 2)}} Jam
                                                    <br><small>({{$item->jumlah_pending}} kali)</small>
                                                </span>
                                            </td>
                                            <td>
                                                <span class="badge badge-danger">
                                                    {{number_format($item->total_lembur_rejected, 2)}} Jam
                                                    <br><small>({{$item->jumlah_rejected}} kali)</small>
                                                </span>
                                            </td>
                                            <td>
                                                <a href="{{url('/admin-laporan/detail/'.$item->user_id)}}" class="btn btn-info btn-sm" title="Lihat Detail">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>
                                                <span class="badge badge-danger">
                                                    {{number_format($data->sum('total_lembur_rejected'), 2)}} Jam
                                                </span>
                                            </th>
                                            <th></th>
                                        </tr>
